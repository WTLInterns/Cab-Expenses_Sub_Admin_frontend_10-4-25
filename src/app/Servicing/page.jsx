...
//                 {cabs
//                   .filter((cab) => cab.vehicleServicing?.kmTravelled > 10000)
//                   .map((cab) => (
//                     <option key={cab._id} value={cab._id}>
//                       {cab.cabNumber} ({cab.vehicleServicing.kmTravelled} km)
//                     </option>
//                   ))}
//               </select>
...
export default function CabService() {
  ...
  // Function to calculate kilometers travelled from meter values
  const calculateKmTravelled = (meterValues) => {
    ...
    return Math.round(totalMeters); // Convert to kilometers
  };
  return (
    <div className="flex bg-gray-900 min-h-screen text-white">
      <Sidebar />
              ...
              >
                ...
                {cabs
                  .filter((cab) => {
                    ...
                    return kmTravelled > 10000;  // Filter cabs with kmTravelled > 10,000
                  })
                  .map((cab) => {
                    const kmTravelled = calculateKmTravelled(cab.vehicleServicing?.meter || []);
                    return (
